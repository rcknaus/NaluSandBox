...
{
  using nodal_scalar_array = typename QuadViews<poly_order>::nodal_scalar_array;
  using nodal_vector_array = typename QuadViews<poly_order>::nodal_vector_array;
  using nodal_tensor_array = typename QuadViews<poly_order>::nodal_tensor_array;
...
: scsDeriv(CoefficientMatrices::scs_derivative_weights<poly_order>()),
  ...
  temp("scratch") {};
  //--------------------------------------------------------------------------
  void nodal_grad(const nodal_scalar_array& f, nodal_vector_array& grad)
  {
  ...
  //--------------------------------------------------------------------------
  void nodal_grad(const nodal_vector_array& f, nodal_tensor_array& grad)
  {
    // computes reference-element gradient at nodes
  ...
  //--------------------------------------------------------------------------
  void scs_yhat_grad(const nodal_scalar_array& f, nodal_vector_array& grad)
  {
  ...
  //--------------------------------------------------------------------------
  void scs_yhat_grad(const nodal_vector_array& f, nodal_tensor_array& grad)
  {
  ...
  //--------------------------------------------------------------------------
  void scs_xhat_grad(const nodal_scalar_array& f, nodal_vector_array& grad)
  {
  ...
  //--------------------------------------------------------------------------
  void scs_xhat_grad(const nodal_vector_array& f, nodal_tensor_array& grad)
  {
    // computes reference-element gradient at scs of constant xhat coordinate
  ...
  //--------------------------------------------------------------------------
  void volume_1D(const nodal_scalar_array& f, nodal_scalar_array& f_bar)
  {
  ...
  //--------------------------------------------------------------------------
  void volume_2D(const nodal_scalar_array& f, nodal_scalar_array& f_bar)
  {
...
private:
  ...
  mutable nodal_scalar_array temp;
};
